 ...
 * @DateTime: 2022/11/11
 */
public class HudiStreamingWrite {
    public static void main(String[] args) throws Exception {
        ...
        MySqlSource<String> mysqlCdcSource = MySqlSource
                ...
                .build();
        RowType rowType = RowType.of(new LogicalType[]{new VarCharType(), new IntType(), new VarCharType()}, new String[]{"name", "age", "gender"});
        ...
        configuration.setString(FlinkOptions.BUCKET_ASSIGN_TASKS.key(), "1");
        configuration.setString(FlinkOptions.WRITE_TASKS.key(), "1");
        ...
        configuration.setString(FlinkOptions.SOURCE_AVRO_SCHEMA, Schema.createRecord("student", "null", "example.arvo", false, fields).toString());

        DataStream<HoodieRecord> bootstrap = Pipelines.bootstrap(configuration, rowType, 1, rowDataSingleOutputStreamOperator);
